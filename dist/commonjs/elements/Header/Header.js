...
var Header = /*#__PURE__*/React.forwardRef(function (props, ref) {
  ...
  var classes = (0, _clsx.default)('ui', color, size, (0, _lib.getKeyOnly)(block, 'block'), (0, _lib.getKeyOnly)(disabled, 'disabled'), (0, _lib.getKeyOnly)(dividing, 'dividing'), (0, _lib.getValueAndKey)(floated, 'floated'), (0, _lib.getKeyOnly)(icon === true, 'icon'), (0, _lib.getKeyOnly)(image === true, 'image'), (0, _lib.getKeyOnly)(inverted, 'inverted'), (0, _lib.getKeyOnly)(sub, 'sub'), (0, _lib.getKeyOrValueAndKey)(attached, 'attached'), (0, _lib.getTextAlignProp)(textAlign), 'header', className);
