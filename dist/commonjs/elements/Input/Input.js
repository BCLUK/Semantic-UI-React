...
var Input = /*#__PURE__*/React.forwardRef(function (props, _ref) {
  ...
  var classes = (0, _clsx.default)('ui', size, (0, _lib.getKeyOnly)(disabled, 'disabled'), (0, _lib.getKeyOnly)(error, 'error'), (0, _lib.getKeyOnly)(fluid, 'fluid'), (0, _lib.getKeyOnly)(focus, 'focus'), (0, _lib.getKeyOnly)(inverted, 'inverted'), (0, _lib.getKeyOnly)(loading, 'loading'), (0, _lib.getKeyOnly)(transparent, 'transparent'), (0, _lib.getValueAndKey)(actionPosition, 'action') || (0, _lib.getKeyOnly)(action, 'action'), (0, _lib.getValueAndKey)(iconPosition, 'icon') || (0, _lib.getKeyOnly)(icon || loading, 'icon'), (0, _lib.getValueAndKey)(labelPosition, 'labeled') || (0, _lib.getKeyOnly)(label, 'labeled'), 'input', className);
    ...
    var childElements = (0, _map2.default)(React.Children.toArray(children), function (child) {
      if (child.type === 'input') {
        return /*#__PURE__*/React.cloneElement(child, (0, _extends2.default)({}, htmlInputProps, child.props, {
          ref: function ref(c) {
            (0, _lib.setRef)(child.props.ref, c);
