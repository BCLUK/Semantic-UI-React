...
var Button = /*#__PURE__*/React.forwardRef(function (props, ref) {
  ...
  var baseClasses = (0, _clsx.default)(color, size, (0, _lib.getKeyOnly)(active, 'active'), (0, _lib.getKeyOnly)(basic, 'basic'), (0, _lib.getKeyOnly)(circular, 'circular'), (0, _lib.getKeyOnly)(compact, 'compact'), (0, _lib.getKeyOnly)(fluid, 'fluid'), (0, _lib.getKeyOnly)(hasIconClass(props), 'icon'), (0, _lib.getKeyOnly)(inverted, 'inverted'), (0, _lib.getKeyOnly)(loading, 'loading'), (0, _lib.getKeyOnly)(negative, 'negative'), (0, _lib.getKeyOnly)(positive, 'positive'), (0, _lib.getKeyOnly)(primary, 'primary'), (0, _lib.getKeyOnly)(secondary, 'secondary'), (0, _lib.getKeyOnly)(toggle, 'toggle'), (0, _lib.getKeyOrValueAndKey)(animated, 'animated'), (0, _lib.getKeyOrValueAndKey)(attached, 'attached'));
  var labeledClasses = (0, _clsx.default)((0, _lib.getKeyOrValueAndKey)(labelPosition || !!label, 'labeled'));
  var wrapperClasses = (0, _clsx.default)((0, _lib.getKeyOnly)(disabled, 'disabled'), (0, _lib.getValueAndKey)(floated, 'floated'));
