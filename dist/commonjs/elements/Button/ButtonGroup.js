...
var ButtonGroup = /*#__PURE__*/React.forwardRef(function (props, ref) {
  var attached = props.attached,
    ...
    widths = props.widths;
  var classes = (0, _clsx.default)('ui', color, size, (0, _lib.getKeyOnly)(basic, 'basic'), (0, _lib.getKeyOnly)(compact, 'compact'), (0, _lib.getKeyOnly)(fluid, 'fluid'), (0, _lib.getKeyOnly)(icon, 'icon'), (0, _lib.getKeyOnly)(inverted, 'inverted'), (0, _lib.getKeyOnly)(labeled, 'labeled'), (0, _lib.getKeyOnly)(negative, 'negative'), (0, _lib.getKeyOnly)(positive, 'positive'), (0, _lib.getKeyOnly)(primary, 'primary'), (0, _lib.getKeyOnly)(secondary, 'secondary'), (0, _lib.getKeyOnly)(toggle, 'toggle'), (0, _lib.getKeyOnly)(vertical, 'vertical'), (0, _lib.getKeyOrValueAndKey)(attached, 'attached'), (0, _lib.getValueAndKey)(floated, 'floated'), (0, _lib.getWidthProp)(widths), 'buttons', className);
