...
var Segment = /*#__PURE__*/React.forwardRef(function (props, ref) {
  ...
  var classes = (0, _clsx.default)('ui', color, size, (0, _lib.getKeyOnly)(basic, 'basic'), (0, _lib.getKeyOnly)(circular, 'circular'), (0, _lib.getKeyOnly)(clearing, 'clearing'), (0, _lib.getKeyOnly)(compact, 'compact'), (0, _lib.getKeyOnly)(disabled, 'disabled'), (0, _lib.getKeyOnly)(inverted, 'inverted'), (0, _lib.getKeyOnly)(loading, 'loading'), (0, _lib.getKeyOnly)(placeholder, 'placeholder'), (0, _lib.getKeyOnly)(piled, 'piled'), (0, _lib.getKeyOnly)(raised, 'raised'), (0, _lib.getKeyOnly)(secondary, 'secondary'), (0, _lib.getKeyOnly)(stacked, 'stacked'), (0, _lib.getKeyOnly)(tertiary, 'tertiary'), (0, _lib.getKeyOnly)(vertical, 'vertical'), (0, _lib.getKeyOrValueAndKey)(attached, 'attached'), (0, _lib.getKeyOrValueAndKey)(padded, 'padded'), (0, _lib.getTextAlignProp)(textAlign), (0, _lib.getValueAndKey)(floated, 'floated'), 'segment', className);
