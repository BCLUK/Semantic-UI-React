...
var Label = /*#__PURE__*/React.forwardRef(function (props, ref) {
  ...
  var classes = (0, _clsx.default)('ui', color, pointingClass, size, (0, _lib.getKeyOnly)(active, 'active'), (0, _lib.getKeyOnly)(basic, 'basic'), (0, _lib.getKeyOnly)(circular, 'circular'), (0, _lib.getKeyOnly)(empty, 'empty'), (0, _lib.getKeyOnly)(floating, 'floating'), (0, _lib.getKeyOnly)(horizontal, 'horizontal'), (0, _lib.getKeyOnly)(image === true, 'image'), (0, _lib.getKeyOnly)(prompt, 'prompt'), (0, _lib.getKeyOnly)(tag, 'tag'), (0, _lib.getKeyOrValueAndKey)(corner, 'corner'), (0, _lib.getKeyOrValueAndKey)(ribbon, 'ribbon'), (0, _lib.getValueAndKey)(attached, 'attached'), 'label', className);
