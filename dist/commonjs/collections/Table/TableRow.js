...
var TableRow = /*#__PURE__*/React.forwardRef(function (props, ref) {
  ...
  var classes = (0, _clsx.default)((0, _lib.getKeyOnly)(active, 'active'), (0, _lib.getKeyOnly)(disabled, 'disabled'), (0, _lib.getKeyOnly)(error, 'error'), (0, _lib.getKeyOnly)(negative, 'negative'), (0, _lib.getKeyOnly)(positive, 'positive'), (0, _lib.getKeyOnly)(warning, 'warning'), (0, _lib.getTextAlignProp)(textAlign), (0, _lib.getVerticalAlignProp)(verticalAlign), className);
