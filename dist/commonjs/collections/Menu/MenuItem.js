...
var MenuItem = /*#__PURE__*/React.forwardRef(function (props, ref) {
  ...
  var classes = (0, _clsx.default)(color, position, (0, _lib.getKeyOnly)(active, 'active'), (0, _lib.getKeyOnly)(disabled, 'disabled'), (0, _lib.getKeyOnly)(icon === true || icon && !(name || content), 'icon'), (0, _lib.getKeyOnly)(header, 'header'), (0, _lib.getKeyOnly)(link, 'link'), (0, _lib.getKeyOrValueAndKey)(fitted, 'fitted'), 'item', className);
