...
var Menu = /*#__PURE__*/React.forwardRef(function (props, ref) {
  ...
  var classes = (0, _clsx.default)('ui', color, size, (0, _lib.getKeyOnly)(borderless, 'borderless'), (0, _lib.getKeyOnly)(compact, 'compact'), (0, _lib.getKeyOnly)(fluid, 'fluid'), (0, _lib.getKeyOnly)(inverted, 'inverted'), (0, _lib.getKeyOnly)(pagination, 'pagination'), (0, _lib.getKeyOnly)(pointing, 'pointing'), (0, _lib.getKeyOnly)(secondary, 'secondary'), (0, _lib.getKeyOnly)(stackable, 'stackable'), (0, _lib.getKeyOnly)(text, 'text'), (0, _lib.getKeyOnly)(vertical, 'vertical'), (0, _lib.getKeyOrValueAndKey)(attached, 'attached'), (0, _lib.getKeyOrValueAndKey)(floated, 'floated'), (0, _lib.getKeyOrValueAndKey)(icon, 'icon'), (0, _lib.getKeyOrValueAndKey)(tabular, 'tabular'), (0, _lib.getValueAndKey)(fixed, 'fixed'), (0, _lib.getWidthProp)(widths, 'item'), className, 'menu');
