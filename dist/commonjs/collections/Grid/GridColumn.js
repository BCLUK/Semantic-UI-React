...
var GridColumn = /*#__PURE__*/React.forwardRef(function (props, ref) {
  var children = props.children,
    ...
    width = props.width;
  var classes = (0, _clsx.default)(color, (0, _lib.getKeyOnly)(stretched, 'stretched'), (0, _lib.getMultipleProp)(only, 'only'), (0, _lib.getTextAlignProp)(textAlign), (0, _lib.getValueAndKey)(floated, 'floated'), (0, _lib.getVerticalAlignProp)(verticalAlign), (0, _lib.getWidthProp)(computer, 'wide computer'), (0, _lib.getWidthProp)(largeScreen, 'wide large screen'), (0, _lib.getWidthProp)(mobile, 'wide mobile'), (0, _lib.getWidthProp)(tablet, 'wide tablet'), (0, _lib.getWidthProp)(widescreen, 'wide widescreen'), (0, _lib.getWidthProp)(width, 'wide'), 'column', className);
