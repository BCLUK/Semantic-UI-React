...
var GridRow = /*#__PURE__*/React.forwardRef(function (props, ref) {
  ...
  var classes = (0, _clsx.default)(color, (0, _lib.getKeyOnly)(centered, 'centered'), (0, _lib.getKeyOnly)(divided, 'divided'), (0, _lib.getKeyOnly)(stretched, 'stretched'), (0, _lib.getMultipleProp)(only, 'only'), (0, _lib.getMultipleProp)(reversed, 'reversed'), (0, _lib.getTextAlignProp)(textAlign), (0, _lib.getVerticalAlignProp)(verticalAlign), (0, _lib.getWidthProp)(columns, 'column', true), 'row', className);
