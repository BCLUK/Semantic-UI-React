...
var Message = /*#__PURE__*/React.forwardRef(function (props, ref) {
  ...
  var classes = (0, _clsx.default)('ui', color, size, (0, _lib.getKeyOnly)(compact, 'compact'), (0, _lib.getKeyOnly)(error, 'error'), (0, _lib.getKeyOnly)(floating, 'floating'), (0, _lib.getKeyOnly)(hidden, 'hidden'), (0, _lib.getKeyOnly)(icon, 'icon'), (0, _lib.getKeyOnly)(info, 'info'), (0, _lib.getKeyOnly)(negative, 'negative'), (0, _lib.getKeyOnly)(positive, 'positive'), (0, _lib.getKeyOnly)(success, 'success'), (0, _lib.getKeyOnly)(visible, 'visible'), (0, _lib.getKeyOnly)(warning, 'warning'), (0, _lib.getKeyOrValueAndKey)(attached, 'attached'), 'message', className);
