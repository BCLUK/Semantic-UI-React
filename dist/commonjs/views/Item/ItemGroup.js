...
var ItemGroup = /*#__PURE__*/React.forwardRef(function (props, ref) {
  ...
  var classes = (0, _clsx.default)('ui', (0, _lib.getKeyOnly)(divided, 'divided'), (0, _lib.getKeyOnly)(link, 'link'), (0, _lib.getKeyOnly)(unstackable, 'unstackable'), (0, _lib.getKeyOrValueAndKey)(relaxed, 'relaxed'), 'items', className);
  ...
  var itemsJSX = (0, _map2.default)(items, function (item) {
    var childKey = item.childKey,
      itemProps = (0, _objectWithoutPropertiesLoose2.default)(item, _excluded);
    var finalKey = childKey != null ? childKey : [itemProps.content, itemProps.description, itemProps.header, itemProps.meta].join('-');
    return /*#__PURE__*/React.createElement(_Item.default, (0, _extends2.default)({}, itemProps, {
      key: finalKey
    }));
  });
  return /*#__PURE__*/React.createElement(ElementType, (0, _extends2.default)({}, rest, {
