...
var Statistic = /*#__PURE__*/React.forwardRef(function (props, ref) {
  var children = props.children,
    ...
    text = props.text,
    value = props.value;
  var classes = (0, _clsx.default)('ui', color, size, (0, _lib.getValueAndKey)(floated, 'floated'), (0, _lib.getKeyOnly)(horizontal, 'horizontal'), (0, _lib.getKeyOnly)(inverted, 'inverted'), 'statistic', className);
