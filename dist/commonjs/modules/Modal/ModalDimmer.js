...
var ModalDimmer = /*#__PURE__*/React.forwardRef(function (props, ref) {
  ...
  var classes = (0, _clsx.default)('ui', (0, _lib.getKeyOnly)(inverted, 'inverted'), (0, _lib.getKeyOnly)(!centered, 'top aligned'), 'page modals dimmer transition visible active', className);
  var bodyClasses = (0, _clsx.default)('dimmable dimmed', (0, _lib.getKeyOnly)(blurring, 'blurring'), (0, _lib.getKeyOnly)(scrolling, 'scrolling'));
