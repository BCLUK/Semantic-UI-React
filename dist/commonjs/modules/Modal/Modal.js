...
var Modal = /*#__PURE__*/React.forwardRef(function (props, ref) {
  ...
  var renderContent = function renderContent(rest) {
    var classes = (0, _clsx.default)('ui', size, (0, _lib.getKeyOnly)(basic, 'basic'), (0, _lib.getKeyOnly)(legacy, 'legacy'), (0, _lib.getKeyOnly)(scrolling, 'scrolling'), 'modal transition visible active', className);
    ...
    }), closeIconJSX, _lib.childrenUtils.isNil(children) ? /*#__PURE__*/React.createElement(React.Fragment, null, _ModalHeader.default.create(header, {
  ...
  return /*#__PURE__*/React.createElement(_Portal.default, (0, _extends2.default)({
