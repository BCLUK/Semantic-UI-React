...
var DimmerInner = /*#__PURE__*/React.forwardRef(function (props, ref) {
  ...
  var containerRef = (0, _lib.useMergedRefs)(ref, React.useRef());
  ...
  var classes = (0, _clsx.default)('ui', (0, _lib.getKeyOnly)(active, 'active transition visible'), (0, _lib.getKeyOnly)(disabled, 'disabled'), (0, _lib.getKeyOnly)(inverted, 'inverted'), (0, _lib.getKeyOnly)(page, 'page'), (0, _lib.getKeyOnly)(simple, 'simple'), (0, _lib.getVerticalAlignProp)(verticalAlign), 'dimmer', className);
...
var _default = exports.default = DimmerInner;