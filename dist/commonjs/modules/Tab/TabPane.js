...
var TabPane = /*#__PURE__*/React.forwardRef(function (props, ref) {
  ...
  var classes = (0, _clsx.default)((0, _lib.getKeyOnly)(active, 'active'), (0, _lib.getKeyOnly)(loading, 'loading'), 'tab', className);
  var rest = (0, _lib.getUnhandledProps)(TabPane, props);
  var ElementType = (0, _lib.getComponentType)(props, {
    defaultAs: _Segment.default
  });
  var calculatedDefaultProps = {};
  if (ElementType === _Segment.default) {
    calculatedDefaultProps.attached = 'bottom';
  }
  return /*#__PURE__*/React.createElement(ElementType, (0, _extends2.default)({}, calculatedDefaultProps, rest, {
    className: classes,
    ref: ref
