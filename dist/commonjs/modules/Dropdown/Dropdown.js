...
var DropdownInner = /*#__PURE__*/function (_Component) {
  ...
  function DropdownInner() {
    ...
    _this.renderMenu = function () {
      ...
      if (!_lib.childrenUtils.isNil(children)) {
        ...
        var className = (0, _clsx.default)(direction, (0, _lib.getKeyOnly)(open, 'visible'), menuChild.props.className);
  ...
  _proto.render = function render() {
    ...
    // Classes
    var classes = (0, _clsx.default)('ui', (0, _lib.getKeyOnly)(open, 'active visible'), (0, _lib.getKeyOnly)(disabled, 'disabled'), (0, _lib.getKeyOnly)(error, 'error'), (0, _lib.getKeyOnly)(loading, 'loading'), (0, _lib.getKeyOnly)(basic, 'basic'), (0, _lib.getKeyOnly)(button, 'button'), (0, _lib.getKeyOnly)(compact, 'compact'), (0, _lib.getKeyOnly)(fluid, 'fluid'), (0, _lib.getKeyOnly)(floating, 'floating'), (0, _lib.getKeyOnly)(inline, 'inline'),
    // TODO: consider augmentation to render Dropdowns as Button/Menu, solves icon/link item issues
    // https://github.com/Semantic-Org/Semantic-UI-React/issues/401#issuecomment-240487229
    // TODO: the icon class is only required when a dropdown is a button
    // getKeyOnly(icon, 'icon'),
    (0, _lib.getKeyOnly)(labeled, 'labeled'), (0, _lib.getKeyOnly)(item, 'item'), (0, _lib.getKeyOnly)(multiple, 'multiple'), (0, _lib.getKeyOnly)(search, 'search'), (0, _lib.getKeyOnly)(selection, 'selection'), (0, _lib.getKeyOnly)(simple, 'simple'), (0, _lib.getKeyOnly)(scrolling, 'scrolling'), (0, _lib.getKeyOnly)(upward, 'upward'), (0, _lib.getKeyOrValueAndKey)(pointing, 'pointing'), 'dropdown', className);
