...
var Progress = /*#__PURE__*/React.forwardRef(function (props, ref) {
  ...
  var classes = (0, _clsx.default)('ui', color, size, (0, _lib.getKeyOnly)(active || indicating, 'active'), (0, _lib.getKeyOnly)(disabled, 'disabled'), (0, _lib.getKeyOnly)(error, 'error'), (0, _lib.getKeyOnly)(indicating, 'indicating'), (0, _lib.getKeyOnly)(inverted, 'inverted'), (0, _lib.getKeyOnly)(success || isAutoSuccess, 'success'), (0, _lib.getKeyOnly)(warning, 'warning'), (0, _lib.getValueAndKey)(attached, 'attached'), 'progress', className);
