...
var SearchCategory = /*#__PURE__*/React.forwardRef(function (props, ref) {
  var active = props.active,
    ...
    layoutRenderer = _props$layoutRenderer === void 0 ? _SearchCategoryLayout.default : _props$layoutRenderer,
    _props$renderer = props.renderer,
    renderer = _props$renderer === void 0 ? function (_ref) {
      var name = _ref.name;
      return name;
    } : _props$renderer;
  var classes = (0, _clsx.default)((0, _lib.getKeyOnly)(active, 'active'), 'category', className);
...
var _default = exports.default = SearchCategory;