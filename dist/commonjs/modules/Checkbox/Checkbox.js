...
var Checkbox = /*#__PURE__*/React.forwardRef(function (props, ref) {
  ...
  var classes = (0, _clsx.default)('ui', (0, _lib.getKeyOnly)(checked, 'checked'), (0, _lib.getKeyOnly)(disabled, 'disabled'), (0, _lib.getKeyOnly)(indeterminate, 'indeterminate'),
  // auto apply fitted class to compact white space when there is no label
  // https://semantic-ui.com/modules/checkbox.html#fitted
  (0, _lib.getKeyOnly)((0, _isNil2.default)(label), 'fitted'), (0, _lib.getKeyOnly)(radio, 'radio'), (0, _lib.getKeyOnly)(readOnly, 'read-only'), (0, _lib.getKeyOnly)(slider, 'slider'), (0, _lib.getKeyOnly)(toggle, 'toggle'), 'checkbox', className);
