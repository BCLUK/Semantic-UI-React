...
var Sidebar = /*#__PURE__*/React.forwardRef(function (props, ref) {
  var animation = props.animation,
    ...
    target = _props$target === void 0 ? _reactComponentEventListener.documentRef : _props$target,
  ...
  var classes = (0, _clsx.default)('ui', animation, direction, width, (0, _lib.getKeyOnly)(animationTick > 0, 'animating'), (0, _lib.getKeyOnly)(visible, 'visible'), 'sidebar', className);
  ...
  return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(ElementType, (0, _extends2.default)({}, rest, {
    className: classes,
    ref: elementRef
  }), _lib.childrenUtils.isNil(children) ? content : children), visible && /*#__PURE__*/React.createElement(_reactComponentEventListener.EventListener, (0, _extends2.default)({
