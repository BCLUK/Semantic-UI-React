...
var Transition = exports.default = /*#__PURE__*/function (_React$Component) {
  ...
  function Transition() {
    ...
    _this.computeClasses = function () {
      ...
      if (isDirectional) {
        return (0, _clsx.default)(animation, childClasses, (0, _lib.getKeyOnly)(animating, 'animating'), (0, _lib.getKeyOnly)(status === _computeStatuses.TRANSITION_STATUS_ENTERING, 'in'), (0, _lib.getKeyOnly)(status === _computeStatuses.TRANSITION_STATUS_EXITING, 'out'), (0, _lib.getKeyOnly)(status === _computeStatuses.TRANSITION_STATUS_EXITED, 'hidden'), (0, _lib.getKeyOnly)(status !== _computeStatuses.TRANSITION_STATUS_EXITED, 'visible'), 'transition');
      }
      return (0, _clsx.default)(animation, childClasses, (0, _lib.getKeyOnly)(animating, 'animating transition'));
    };
