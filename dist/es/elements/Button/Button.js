...
import { childrenUtils, customPropTypes, createShorthandFactory, getComponentType, getUnhandledProps, SUI, getKeyOnly, getKeyOrValueAndKey, getValueAndKey, useMergedRefs } from '../../lib';
...
var Button = /*#__PURE__*/React.forwardRef(function (props, ref) {
  ...
  var baseClasses = cx(color, size, getKeyOnly(active, 'active'), getKeyOnly(basic, 'basic'), getKeyOnly(circular, 'circular'), getKeyOnly(compact, 'compact'), getKeyOnly(fluid, 'fluid'), getKeyOnly(hasIconClass(props), 'icon'), getKeyOnly(inverted, 'inverted'), getKeyOnly(loading, 'loading'), getKeyOnly(negative, 'negative'), getKeyOnly(positive, 'positive'), getKeyOnly(primary, 'primary'), getKeyOnly(secondary, 'secondary'), getKeyOnly(toggle, 'toggle'), getKeyOrValueAndKey(animated, 'animated'), getKeyOrValueAndKey(attached, 'attached'));
  var labeledClasses = cx(getKeyOrValueAndKey(labelPosition || !!label, 'labeled'));
  var wrapperClasses = cx(getKeyOnly(disabled, 'disabled'), getValueAndKey(floated, 'floated'));
