...
import { childrenUtils, createShorthandFactory, customPropTypes, getComponentType, getUnhandledProps, getKeyOnly, useEventCallback } from '../../lib';
...
var Step = /*#__PURE__*/React.forwardRef(function (props, ref) {
  ...
  var classes = cx(getKeyOnly(active, 'active'), getKeyOnly(completed, 'completed'), getKeyOnly(disabled, 'disabled'), getKeyOnly(link, 'link'), 'step', className);
