...
import { childrenUtils, customPropTypes, getComponentType, getUnhandledProps, numberToWordMap, SUI, getKeyOnly, getKeyOrValueAndKey, getValueAndKey, getWidthProp } from '../../lib';
...
var StepGroup = /*#__PURE__*/React.forwardRef(function (props, ref) {
  var attached = props.attached,
    ...
    widths = props.widths;
  var classes = cx('ui', size, getKeyOnly(fluid, 'fluid'), getKeyOnly(ordered, 'ordered'), getKeyOnly(unstackable, 'unstackable'), getKeyOnly(vertical, 'vertical'), getKeyOrValueAndKey(attached, 'attached'), getValueAndKey(stackable, 'stackable'), getWidthProp(widths), 'steps', className);
