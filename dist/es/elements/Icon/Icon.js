...
import { createShorthandFactory, customPropTypes, getComponentType, getUnhandledProps, SUI, useEventCallback, getKeyOnly, getKeyOrValueAndKey, getValueAndKey } from '../../lib';
...
var Icon = /*#__PURE__*/React.forwardRef(function (props, ref) {
  var bordered = props.bordered,
    ...
    size = props.size;
  var classes = cx(color, name, size, getKeyOnly(bordered, 'bordered'), getKeyOnly(circular, 'circular'), getKeyOnly(disabled, 'disabled'), getKeyOnly(fitted, 'fitted'), getKeyOnly(inverted, 'inverted'), getKeyOnly(link, 'link'), getKeyOnly(loading, 'loading'), getKeyOrValueAndKey(corner, 'corner'), getValueAndKey(flipped, 'flipped'), getValueAndKey(rotated, 'rotated'), 'icon', className);
