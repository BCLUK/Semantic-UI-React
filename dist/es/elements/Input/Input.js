...
import { childrenUtils, createHTMLInput, createShorthandFactory, customPropTypes, getComponentType, getUnhandledProps, partitionHTMLProps, getKeyOnly, getValueAndKey, setRef } from '../../lib';
...
var Input = /*#__PURE__*/React.forwardRef(function (props, _ref) {
  ...
  var classes = cx('ui', size, getKeyOnly(disabled, 'disabled'), getKeyOnly(error, 'error'), getKeyOnly(fluid, 'fluid'), getKeyOnly(focus, 'focus'), getKeyOnly(inverted, 'inverted'), getKeyOnly(loading, 'loading'), getKeyOnly(transparent, 'transparent'), getValueAndKey(actionPosition, 'action') || getKeyOnly(action, 'action'), getValueAndKey(iconPosition, 'icon') || getKeyOnly(icon || loading, 'icon'), getValueAndKey(labelPosition, 'labeled') || getKeyOnly(label, 'labeled'), 'input', className);
