...
var Rail = /*#__PURE__*/React.forwardRef(function (props, ref) {
  var attached = props.attached,
    ...
    size = props.size;
  var classes = cx('ui', position, size, getKeyOnly(attached, 'attached'), getKeyOnly(dividing, 'dividing'), getKeyOnly(internal, 'internal'), getKeyOrValueAndKey(close, 'close'), 'rail', className);
