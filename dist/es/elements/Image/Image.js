...
import { childrenUtils, createShorthandFactory, customPropTypes, getComponentType, getUnhandledProps, htmlImageProps, partitionHTMLProps, SUI, getKeyOnly, getKeyOrValueAndKey, getValueAndKey, getVerticalAlignProp } from '../../lib';
...
var Image = /*#__PURE__*/React.forwardRef(function (props, ref) {
  ...
  var classes = cx(getKeyOnly(ui, 'ui'), size, getKeyOnly(avatar, 'avatar'), getKeyOnly(bordered, 'bordered'), getKeyOnly(circular, 'circular'), getKeyOnly(centered, 'centered'), getKeyOnly(disabled, 'disabled'), getKeyOnly(fluid, 'fluid'), getKeyOnly(hidden, 'hidden'), getKeyOnly(inline, 'inline'), getKeyOnly(rounded, 'rounded'), getKeyOrValueAndKey(spaced, 'spaced'), getValueAndKey(floated, 'floated'), getVerticalAlignProp(verticalAlign, 'aligned'), 'image', className);
