...
import { childrenUtils, customPropTypes, getComponentType, getUnhandledProps, SUI, getValueAndKey, getTextAlignProp, getKeyOrValueAndKey, getKeyOnly } from '../../lib';
...
var Header = /*#__PURE__*/React.forwardRef(function (props, ref) {
  ...
  var classes = cx('ui', color, size, getKeyOnly(block, 'block'), getKeyOnly(disabled, 'disabled'), getKeyOnly(dividing, 'dividing'), getValueAndKey(floated, 'floated'), getKeyOnly(icon === true, 'icon'), getKeyOnly(image === true, 'image'), getKeyOnly(inverted, 'inverted'), getKeyOnly(sub, 'sub'), getKeyOrValueAndKey(attached, 'attached'), getTextAlignProp(textAlign), 'header', className);
