...
import { childrenUtils, customPropTypes, getComponentType, getUnhandledProps, getKeyOnly, getKeyOrValueAndKey } from '../../lib';
...
var ItemGroup = /*#__PURE__*/React.forwardRef(function (props, ref) {
  ...
  var classes = cx('ui', getKeyOnly(divided, 'divided'), getKeyOnly(link, 'link'), getKeyOnly(unstackable, 'unstackable'), getKeyOrValueAndKey(relaxed, 'relaxed'), 'items', className);
