...
import { childrenUtils, customPropTypes, getComponentType, getUnhandledProps, SUI, getKeyOnly, getWidthProp } from '../../lib';
...
var StatisticGroup = /*#__PURE__*/React.forwardRef(function (props, ref) {
  var children = props.children,
    ...
    size = props.size,
    widths = props.widths;
  var classes = cx('ui', color, size, getKeyOnly(horizontal, 'horizontal'), getKeyOnly(inverted, 'inverted'), getWidthProp(widths), 'statistics', className);
