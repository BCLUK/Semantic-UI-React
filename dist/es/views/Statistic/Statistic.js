...
import { childrenUtils, createShorthandFactory, customPropTypes, getComponentType, getUnhandledProps, SUI, getKeyOnly, getValueAndKey } from '../../lib';
...
var Statistic = /*#__PURE__*/React.forwardRef(function (props, ref) {
  var children = props.children,
    ...
    text = props.text,
    value = props.value;
  var classes = cx('ui', color, size, getValueAndKey(floated, 'floated'), getKeyOnly(horizontal, 'horizontal'), getKeyOnly(inverted, 'inverted'), 'statistic', className);
