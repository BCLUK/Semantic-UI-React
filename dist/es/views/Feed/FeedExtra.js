...
import { childrenUtils, createHTMLImage, customPropTypes, getComponentType, getUnhandledProps, getKeyOnly } from '../../lib';
...
var FeedExtra = /*#__PURE__*/React.forwardRef(function (props, ref) {
  var children = props.children,
    ...
    images = props.images,
    text = props.text;
  var classes = cx(getKeyOnly(images, 'images'), getKeyOnly(content || text, 'text'), 'extra', className);
