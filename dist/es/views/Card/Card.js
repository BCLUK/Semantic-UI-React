...
import { childrenUtils, customPropTypes, getComponentType, getUnhandledProps, SUI, getKeyOnly, useEventCallback } from '../../lib';
...
var Card = /*#__PURE__*/React.forwardRef(function (props, ref) {
  var centered = props.centered,
    ...
    raised = props.raised;
  var classes = cx('ui', color, getKeyOnly(centered, 'centered'), getKeyOnly(fluid, 'fluid'), getKeyOnly(link, 'link'), getKeyOnly(raised, 'raised'), 'card', className);
