...
import { normalizeTransitionDuration, SUI, getKeyOnly } from '../../lib';
...
var Transition = /*#__PURE__*/function (_React$Component) {
  ...
  function Transition() {
    ...
    _this.computeClasses = function () {
      ...
      if (isDirectional) {
        return cx(animation, childClasses, getKeyOnly(animating, 'animating'), getKeyOnly(status === TRANSITION_STATUS_ENTERING, 'in'), getKeyOnly(status === TRANSITION_STATUS_EXITING, 'out'), getKeyOnly(status === TRANSITION_STATUS_EXITED, 'hidden'), getKeyOnly(status !== TRANSITION_STATUS_EXITED, 'visible'), 'transition');
      }
