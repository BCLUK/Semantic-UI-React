...
import { childrenUtils, createShorthand, createShorthandFactory, customPropTypes, getComponentType, getUnhandledProps, getKeyOnly } from '../../lib';
...
var DropdownItem = /*#__PURE__*/React.forwardRef(function (props, ref) {
  ...
  var classes = cx(getKeyOnly(active, 'active'), getKeyOnly(disabled, 'disabled'), getKeyOnly(selected, 'selected'), 'item', className);
