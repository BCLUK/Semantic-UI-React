...
import { ModernAutoControlledComponent as Component, childrenUtils, customPropTypes, doesNodeContainClick, getComponentType, getUnhandledProps, objectDiff, setRef, getKeyOnly, getKeyOrValueAndKey } from '../../lib';
...
var DropdownInner = /*#__PURE__*/function (_Component) {
  ...
  function DropdownInner() {
    ...
    _this.renderMenu = function () {
      ...
      if (!childrenUtils.isNil(children)) {
        ...
        var className = cx(direction, getKeyOnly(open, 'visible'), menuChild.props.className);
  ...
  _proto.render = function render() {
    ...
    // Classes
    var classes = cx('ui', getKeyOnly(open, 'active visible'), getKeyOnly(disabled, 'disabled'), getKeyOnly(error, 'error'), getKeyOnly(loading, 'loading'), getKeyOnly(basic, 'basic'), getKeyOnly(button, 'button'), getKeyOnly(compact, 'compact'), getKeyOnly(fluid, 'fluid'), getKeyOnly(floating, 'floating'), getKeyOnly(inline, 'inline'),
    // TODO: consider augmentation to render Dropdowns as Button/Menu, solves icon/link item issues
    // https://github.com/Semantic-Org/Semantic-UI-React/issues/401#issuecomment-240487229
    // TODO: the icon class is only required when a dropdown is a button
    // getKeyOnly(icon, 'icon'),
    getKeyOnly(labeled, 'labeled'), getKeyOnly(item, 'item'), getKeyOnly(multiple, 'multiple'), getKeyOnly(search, 'search'), getKeyOnly(selection, 'selection'), getKeyOnly(simple, 'simple'), getKeyOnly(scrolling, 'scrolling'), getKeyOnly(upward, 'upward'), getKeyOrValueAndKey(pointing, 'pointing'), 'dropdown', className);
