...
import { getComponentType, getUnhandledProps, SUI, getKeyOnly, useAutoControlledValue } from '../../lib';
...
var Rating = /*#__PURE__*/React.forwardRef(function (props, ref) {
  ...
  var classes = cx('ui', icon, size, getKeyOnly(disabled, 'disabled'), getKeyOnly(isSelecting && !disabled && selectedIndex >= 0, 'selected'), 'rating', className);
