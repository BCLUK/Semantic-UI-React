...
import { childrenUtils, customPropTypes, doesNodeContainClick, getUnhandledProps, getComponentType, isRefObject, getKeyOnly, useIsomorphicLayoutEffect, useEventCallback, useForceUpdate, useMergedRefs, usePrevious } from '../../lib';
...
var Sidebar = /*#__PURE__*/React.forwardRef(function (props, ref) {
  ...
  var classes = cx('ui', animation, direction, width, getKeyOnly(animationTick > 0, 'animating'), getKeyOnly(visible, 'visible'), 'sidebar', className);
