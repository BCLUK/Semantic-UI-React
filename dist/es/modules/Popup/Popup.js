...
import { childrenUtils, createHTMLDivision, customPropTypes, getComponentType, getUnhandledProps, SUI, useIsomorphicLayoutEffect, getKeyOnly, getKeyOrValueAndKey, useMergedRefs, usePrevious } from '../../lib';
...
var Popup = /*#__PURE__*/React.forwardRef(function (props, ref) {
  ...
  var _partitionPortalProps = partitionPortalProps(unhandledProps, disabled),
  ...
  var renderBody = function renderBody(_ref) {
    ...
    var classes = cx('ui', placementMapping[popperPlacement], size, getKeyOrValueAndKey(wide, 'wide'), getKeyOnly(basic, 'basic'), getKeyOnly(flowing, 'flowing'), getKeyOnly(inverted, 'inverted'), 'popup transition visible', className);
