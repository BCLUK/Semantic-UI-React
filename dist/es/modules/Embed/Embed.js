...
import { childrenUtils, createHTMLIframe, customPropTypes, getComponentType, getUnhandledProps, getKeyOnly, useAutoControlledValue } from '../../lib';
...
var Embed = /*#__PURE__*/React.forwardRef(function (props, ref) {
  ...
  var classes = cx('ui', aspectRatio, getKeyOnly(active, 'active'), 'embed', className);
