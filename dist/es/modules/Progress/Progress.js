...
import { childrenUtils, createHTMLDivision, customPropTypes, getComponentType, getUnhandledProps, SUI, getKeyOnly, getValueAndKey } from '../../lib';
...
var Progress = /*#__PURE__*/React.forwardRef(function (props, ref) {
  ...
  var classes = cx('ui', color, size, getKeyOnly(active || indicating, 'active'), getKeyOnly(disabled, 'disabled'), getKeyOnly(error, 'error'), getKeyOnly(indicating, 'indicating'), getKeyOnly(inverted, 'inverted'), getKeyOnly(success || isAutoSuccess, 'success'), getKeyOnly(warning, 'warning'), getValueAndKey(attached, 'attached'), 'progress', className);
