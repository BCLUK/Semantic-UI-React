...
import { childrenUtils, customPropTypes, doesNodeContainClick, eventStack, getComponentType, getUnhandledProps, isBrowser, getKeyOnly, useAutoControlledValue, useMergedRefs } from '../../lib';
...
var Modal = /*#__PURE__*/React.forwardRef(function (props, ref) {
  ...
  var renderContent = function renderContent(rest) {
    var classes = cx('ui', size, getKeyOnly(basic, 'basic'), getKeyOnly(legacy, 'legacy'), getKeyOnly(scrolling, 'scrolling'), 'modal transition visible active', className);
