...
import { childrenUtils, createShorthandFactory, customPropTypes, getComponentType, getUnhandledProps, getKeyOnly } from '../../lib';
...
var ModalContent = /*#__PURE__*/React.forwardRef(function (props, ref) {
  ...
  var classes = cx(className, getKeyOnly(image, 'image'), getKeyOnly(scrolling, 'scrolling'), 'content');
