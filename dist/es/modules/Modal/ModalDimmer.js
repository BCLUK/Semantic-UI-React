...
import { childrenUtils, createShorthandFactory, customPropTypes, getComponentType, getUnhandledProps, useClassNamesOnNode, getKeyOnly, useMergedRefs } from '../../lib';
...
var ModalDimmer = /*#__PURE__*/React.forwardRef(function (props, ref) {
  ...
  var classes = cx('ui', getKeyOnly(inverted, 'inverted'), getKeyOnly(!centered, 'top aligned'), 'page modals dimmer transition visible active', className);
  var bodyClasses = cx('dimmable dimmed', getKeyOnly(blurring, 'blurring'), getKeyOnly(scrolling, 'scrolling'));
