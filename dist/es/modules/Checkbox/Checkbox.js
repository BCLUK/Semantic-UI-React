...
import { createHTMLLabel, customPropTypes, getComponentType, getUnhandledProps, htmlInputAttrs, partitionHTMLProps, getKeyOnly, useAutoControlledValue, useMergedRefs, useIsomorphicLayoutEffect } from '../../lib';
/**
...
var Checkbox = /*#__PURE__*/React.forwardRef(function (props, ref) {
  ...
  var classes = cx('ui', getKeyOnly(checked, 'checked'), getKeyOnly(disabled, 'disabled'), getKeyOnly(indeterminate, 'indeterminate'),
  // auto apply fitted class to compact white space when there is no label
  // https://semantic-ui.com/modules/checkbox.html#fitted
  getKeyOnly(_isNil(label), 'fitted'), getKeyOnly(radio, 'radio'), getKeyOnly(readOnly, 'read-only'), getKeyOnly(slider, 'slider'), getKeyOnly(toggle, 'toggle'), 'checkbox', className);
