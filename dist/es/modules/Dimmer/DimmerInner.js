...
import { childrenUtils, customPropTypes, doesNodeContainClick, getComponentType, getUnhandledProps, getKeyOnly, getVerticalAlignProp, useIsomorphicLayoutEffect, useMergedRefs } from '../../lib';
...
var DimmerInner = /*#__PURE__*/React.forwardRef(function (props, ref) {
  ...
  var classes = cx('ui', getKeyOnly(active, 'active transition visible'), getKeyOnly(disabled, 'disabled'), getKeyOnly(inverted, 'inverted'), getKeyOnly(page, 'page'), getKeyOnly(simple, 'simple'), getVerticalAlignProp(verticalAlign), 'dimmer', className);
