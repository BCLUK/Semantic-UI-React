...
import { ModernAutoControlledComponent as Component, customPropTypes, eventStack, getComponentType, getUnhandledProps, htmlInputAttrs, isBrowser, objectDiff, partitionHTMLProps, SUI, getKeyOnly, getValueAndKey } from '../../lib';
...
var SearchInner = /*#__PURE__*/function (_Component) {
  ...
  _proto.render = function render() {
    ...
    // Classes
    var classes = cx('ui', open && 'active visible', size, searchClasses, getKeyOnly(category, 'category'), getKeyOnly(focus, 'focus'), getKeyOnly(fluid, 'fluid'), getKeyOnly(loading, 'loading'), getValueAndKey(aligned, 'aligned'), 'search', className);
