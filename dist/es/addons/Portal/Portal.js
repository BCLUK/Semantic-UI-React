...
import { customPropTypes, doesNodeContainClick, useAutoControlledValue, useEventCallback } from '../../lib';
...
function Portal(props) {
  var children = props.children,
    ...
    _props$hideOnScroll = props.hideOnScroll,
    hideOnScroll = _props$hideOnScroll === void 0 ? false : _props$hideOnScroll;
  ...
  var closePortal = useEventCallback(function (e) {
    setOpen(false);
  ...
  React.useEffect(function () {
    ...
    var handleScroll = function handleScroll(e) {
      ...
      if (_isElement(e.target) && contentRef.current.contains(e.target)) {
        return;
      }
      closePortal(e);
    };
...
Portal.handledProps = ["children", "closeOnDocumentClick", "closeOnEscape", "closeOnPortalMouseLeave", "closeOnTriggerBlur", "closeOnTriggerClick", "closeOnTriggerMouseLeave", "defaultOpen", "eventPool", "hideOnScroll", "mountNode", "mouseEnterDelay", "mouseLeaveDelay", "onClose", "onMount", "onOpen", "onUnmount", "open", "openOnTriggerClick", "openOnTriggerFocus", "openOnTriggerMouseEnter", "trigger", "triggerRef"];
