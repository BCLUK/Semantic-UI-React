...
import { childrenUtils, createHTMLParagraph, customPropTypes, getComponentType, getUnhandledProps, SUI, getKeyOnly, getKeyOrValueAndKey, useEventCallback } from '../../lib';
...
var Message = /*#__PURE__*/React.forwardRef(function (props, ref) {
  ...
  var classes = cx('ui', color, size, getKeyOnly(compact, 'compact'), getKeyOnly(error, 'error'), getKeyOnly(floating, 'floating'), getKeyOnly(hidden, 'hidden'), getKeyOnly(icon, 'icon'), getKeyOnly(info, 'info'), getKeyOnly(negative, 'negative'), getKeyOnly(positive, 'positive'), getKeyOnly(success, 'success'), getKeyOnly(visible, 'visible'), getKeyOnly(warning, 'warning'), getKeyOrValueAndKey(attached, 'attached'), 'message', className);
