...
import { customPropTypes, getComponentType, getUnhandledProps, SUI, getKeyOnly, getWidthProp } from '../../lib';
...
var FormGroup = /*#__PURE__*/React.forwardRef(function (props, ref) {
  var children = props.children,
    ...
    widths = props.widths;
  var classes = cx(getKeyOnly(error, 'error'), getKeyOnly(disabled, 'disabled'), getKeyOnly(grouped, 'grouped'), getKeyOnly(inline, 'inline'), getKeyOnly(unstackable, 'unstackable'), getWidthProp(widths, null, true), 'fields', className);
