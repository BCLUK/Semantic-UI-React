...
import { childrenUtils, createHTMLLabel, customPropTypes, getComponentType, getUnhandledProps, SUI, getKeyOnly, getWidthProp } from '../../lib';
...
var FormField = /*#__PURE__*/React.forwardRef(function (props, ref) {
  var children = props.children,
    ...
    width = props.width,
    id = props.id;
  var classes = cx(getKeyOnly(disabled, 'disabled'), getKeyOnly(error, 'error'), getKeyOnly(inline, 'inline'), getKeyOnly(required, 'required'), getWidthProp(width, 'wide'), 'field', className);
