...
import { childrenUtils, createShorthandFactory, customPropTypes, getUnhandledProps, getComponentType, getKeyOnly, useEventCallback } from '../../lib';
...
var BreadcrumbSection = /*#__PURE__*/React.forwardRef(function (props, ref) {
  ...
  var classes = cx(getKeyOnly(active, 'active'), 'section', className);
