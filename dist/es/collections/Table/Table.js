...
import { childrenUtils, customPropTypes, getComponentType, getUnhandledProps, SUI, getKeyOnly, getKeyOrValueAndKey, getTextAlignProp, getVerticalAlignProp, getWidthProp } from '../../lib';
...
var Table = /*#__PURE__*/React.forwardRef(function (props, ref) {
  ...
  var classes = cx('ui', color, size, getKeyOnly(celled, 'celled'), getKeyOnly(collapsing, 'collapsing'), getKeyOnly(definition, 'definition'), getKeyOnly(fixed, 'fixed'), getKeyOnly(inverted, 'inverted'), getKeyOnly(selectable, 'selectable'), getKeyOnly(singleLine, 'single line'), getKeyOnly(sortable, 'sortable'), getKeyOnly(stackable, 'stackable'), getKeyOnly(striped, 'striped'), getKeyOnly(structured, 'structured'), getKeyOnly(unstackable, 'unstackable'), getKeyOrValueAndKey(attached, 'attached'), getKeyOrValueAndKey(basic, 'basic'), getKeyOrValueAndKey(compact, 'compact'), getKeyOrValueAndKey(padded, 'padded'), getTextAlignProp(textAlign), getVerticalAlignProp(verticalAlign), getWidthProp(columns, 'column'), 'table', className);
