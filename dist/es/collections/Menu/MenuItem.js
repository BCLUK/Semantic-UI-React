...
import { childrenUtils, createShorthandFactory, customPropTypes, getComponentType, getUnhandledProps, SUI, getKeyOnly, getKeyOrValueAndKey, useEventCallback } from '../../lib';
...
var MenuItem = /*#__PURE__*/React.forwardRef(function (props, ref) {
  ...
  var classes = cx(color, position, getKeyOnly(active, 'active'), getKeyOnly(disabled, 'disabled'), getKeyOnly(icon === true || icon && !(name || content), 'icon'), getKeyOnly(header, 'header'), getKeyOnly(link, 'link'), getKeyOrValueAndKey(fitted, 'fitted'), 'item', className);
